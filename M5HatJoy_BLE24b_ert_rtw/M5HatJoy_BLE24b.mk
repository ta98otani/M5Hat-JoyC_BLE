###########################################################################
## Makefile generated for component 'M5HatJoy_BLE24b'. 
## 
## Makefile     : M5HatJoy_BLE24b.mk
## Generated on : Mon Dec 15 21:28:54 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/M5HatJoy_BLE24b.elf
...
PRODUCT_NAME              = M5HatJoy_BLE24b
MAKEFILE                  = M5HatJoy_BLE24b.mk
MATLAB_ROOT               = C:/MATLAB/R2024b
MATLAB_BIN                = C:/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/totani/ONEDRI~1/demos/M5Stack/M5HAT-~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/totani/DOCUME~1/MATLAB/R2024b/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/M5HatJoy_BLE24b.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/src -I$(START_DIR)/M5HatJoy_BLE24b_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/cores/esp32 -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/variants/esp32 -I$(ARDUINO_ESP32_ROOT)/tools/esptool_py -I$(ARDUINO_ESP32_ROOT)/tools/mkspiffs -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/scheduler/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinobase/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/shared/freertos/include -I$(START_DIR)/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/esp32/hardware/esp32/2.0.11/libraries/Wire/src -IC:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/esp32/hardware/esp32/2.0.11/libraries/SPI/src -IC:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/user/libraries/ServoESP32/src
...
DEFINES_STANDARD = -DMODEL=M5HatJoy_BLE24b -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = M5HatJoySensors.o Hat_JoyC.o xcp_ext_mode.o M5HatJoy_BLE24b.o M5HatJoy_BLE24b_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/M5HatJoy_BLE24b_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/M5HatJoy_BLE24b_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/M5HatJoy_BLE24b_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
M5HatJoySensors.o : $(START_DIR)/src/M5HatJoySensors.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Hat_JoyC.o : $(START_DIR)/src/Hat_JoyC.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/M5HatJoy_BLE24b_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


M5HatJoy_BLE24b.o : $(START_DIR)/M5HatJoy_BLE24b_ert_rtw/M5HatJoy_BLE24b.c
	$(CC) $(CFLAGS) -o "$@" "$<"


M5HatJoy_BLE24b_data.o : $(START_DIR)/M5HatJoy_BLE24b_ert_rtw/M5HatJoy_BLE24b_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
